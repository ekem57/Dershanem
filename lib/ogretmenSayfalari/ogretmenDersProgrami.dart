...
class OgretmenDersProgrami extends StatefulWidget {
  final DocumentSnapshot card;

  OgretmenDersProgrami({ @required this.card});
  @override
  _OgretmenDersProgramiState createState() => _OgretmenDersProgramiState();
}

class _OgretmenDersProgramiState extends State<OgretmenDersProgrami> with SingleTickerProviderStateMixin {
