...
class OgretmenGiris extends StatefulWidget {
  @override
  _OgretmenGirisState createState() => _OgretmenGirisState();
}
...
class _OgretmenGirisState extends State<OgretmenGiris> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(child: Text("Ögretmen Giris",style: GoogleFonts.patuaOne(fontSize: 30.0.spByWidth,color: Colors.black),)),
                    ...
                    Center(
                      child: FlatButton(
                        ...
                        child: InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) => Kayit_Sayfasi(kayitTuru: "Ogretmen",)),);
                            },
  ...
  void _validateInputs(BuildContext context) async {
    final _userModel = Provider.of<OgretmenModel>(context,listen: false);
    ...
    if (_formKey1.currentState.validate()) {
      ...
      try {
        ...
        Ogretmen _girisYapanUser = await _userModel.signInWithEmailandPasswordOgretmen(_emailcontroller.text, _sifrecontroller.text);
