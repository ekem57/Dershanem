...
class YonetimGiris extends StatefulWidget {
  @override
  _YonetimGirisState createState() => _YonetimGirisState();
}
...
class _YonetimGirisState extends State<YonetimGiris> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(child: Text("Yönetim Giris",style: GoogleFonts.patuaOne(fontSize: 30.0.spByWidth,color: Colors.black),)),
                    SizedBox(height: 50.0.h,),
                    Myinput(hintText:"E-mail" ,icon: Icon(Icons.email,color: Colors.green,),onSaved: validateEmail,controller: _emailcontroller,passwordVisible: false,keybordType: TextInputType.emailAddress,),
                    Myinput(hintText:"Şifre" ,icon: Icon(Icons.lock,color: Colors.green,),onSaved: validateSifre,controller: _sifrecontroller,passwordVisible: true,keybordType: TextInputType.emailAddress,),
                    SizedBox(height: 10.0.h,),
                    Center(
                    ...
                    Center(
                      child: InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => Kayit_Sayfasi(kayitTuru: "Yonetici",)),);
                          },
  ...
  void _validateInputs(BuildContext context) async {
    final _userModel = Provider.of<YoneticiModel>(context,listen: false);
    ...
    if (_formKey1.currentState.validate()) {
      ...
      try {
        ...
        Yonetici _girisYapanUser = await _userModel.signInWithEmailandPasswordYonetici(_emailcontroller.text, _sifrecontroller.text);
