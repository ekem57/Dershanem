              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(child: Text("Ögrenci Giris",style: GoogleFonts.patuaOne(fontSize: 30.0.spByWidth,color: Colors.black),)),
                    ...
                    Myinput(hintText:"Şifre" ,icon: Icon(Icons.lock,color: Colors.green,),controller: _sifrecontroller,keybordType: TextInputType.emailAddress,passwordVisible: true),
                    SizedBox(height: 10.0.h,),
                    Center(
