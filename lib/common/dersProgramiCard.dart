...
class DersProgramiCard extends StatelessWidget {
  final String sinif;
  final String ders;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(ders,style: TextStyle(fontSize: 15.0.spByWidth),),
                    Column(
                      children: [
                        Text("Sınıf",style: TextStyle(fontSize: 15.0.spByWidth),),
                        SizedBox(height: 10,),
                        Text(sinif,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15.0.spByWidth)),
                      ],
                    ),
                  ],
                ),
