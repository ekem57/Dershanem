...
class SikayetTavsiyeIcerik extends StatefulWidget {

  final DocumentSnapshot card;
  final String tarih;
  SikayetTavsiyeIcerik({this.card,this.tarih});

  @override
  _SikayetTavsiyeIcerikState createState() => _SikayetTavsiyeIcerikState();
}

class _SikayetTavsiyeIcerikState extends State<SikayetTavsiyeIcerik> {
