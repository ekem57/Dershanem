...
class _ChattKisiSecState extends State<ChattKisiSec> {
  ...
  Widget build(BuildContext context) {
    final _ogretmenModel = Provider.of<YoneticiModel>(context, listen: false);
                    ...
                    Navigator.of(context, rootNavigator: true).push(
                      MaterialPageRoute(
                        builder: (context) => ChangeNotifierProvider(
                          create: (context) => ChatViewModel(currentUser: _ogretmenModel.user, sohbetEdilenUser: Ogretmen.fromMap(_card.data())),
