...
class AllUserViewModel with ChangeNotifier {
  ...
  List<Ogretmen> get kullanicilarListesi => _tumKullanicilar;
  ...
  getUserWithPagination(Ogretmen enSonGetirilenUser, bool yeniElemanlarGetiriliyor,String userid) async {
